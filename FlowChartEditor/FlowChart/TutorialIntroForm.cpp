...
int TutorialIntroForm::OnCreate(LPCREATESTRUCT lpCreateStruct) {
	...
	this->message = new TextRegion(800, 400, 600, 100, RGB(255,255,255), DOT, RGB(52, 52, 52), String("따라해 봅시다."));
	this->guide = new TextRegion(880, 550, 600, 100, RGB(235, 235, 235), DOT, RGB(52, 52, 52), String("Press any key..."));
